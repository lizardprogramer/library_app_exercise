...
<body class="mb-48">
  ...
  <main>
    ...
    <div class="bg-gray-50 border border-gray-200 p-10 rounded max-w-lg mx-auto mt-24">
      ...
      <form method="POST" action="http://localhost/LibraryApp/public/books" enctype="multipart/form-data">
        @csrf
        <div class="mb-6">
          <label for="company" class="inline-block text-lg mb-2">Book title</label>
        ...
        <div class="mb-6">
          <label for="author_id" class="inline-block text-lg mb-2">Author</label>
          <select name='author_id' class='border border-gray-200 rounded p-2 w-full'>
        ...
        <div class="mb-6">
          ...
          <textarea class="border border-gray-200 rounded p-2 w-full" name="description" rows="7"
            placeholder="Once upon a time in a land far far away....">{{old('description')}}</textarea>
          @error('description')
          <p class="text-red-500 text xs mt-1">{{$message}}</p>
          @enderror
        </div>
        ...
        <div class="mt-8">
          <p>
            ...
            <a href="http://localhost/LibraryApp/public/admin/authors" class="text-laravel">Add author</a>
          </p>
        </div>
      </form>
    </div>
